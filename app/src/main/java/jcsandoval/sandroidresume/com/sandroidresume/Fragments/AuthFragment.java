...
import jcsandoval.sandroidresume.com.sandroidresume.Utils.VerticalTextView;
...
public abstract class AuthFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        mDrawable = (ParticlesDrawable) ContextCompat
                .getDrawable(Objects.requireNonNull(getContext()), R.drawable.particles_dots);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        parent.setBackground(mDrawable);
