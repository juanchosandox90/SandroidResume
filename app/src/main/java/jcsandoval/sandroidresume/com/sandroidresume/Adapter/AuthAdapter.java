package jcsandoval.sandroidresume.com.sandroidresume.Adapter;
...
import jcsandoval.sandroidresume.com.sandroidresume.Fragments.AuthFragment;
import jcsandoval.sandroidresume.com.sandroidresume.Fragments.LogInFragment;
import jcsandoval.sandroidresume.com.sandroidresume.Fragments.SignUpFragment;
...
public class AuthAdapter extends FragmentStatePagerAdapter implements AuthFragment.Callback {
    ...
    private void shiftSharedElements(float pageOffsetX, boolean forward) {
        ...
        int color = ContextCompat.getColor(context, forward ? R.color.white_transparent : R.color.white_transparent);
